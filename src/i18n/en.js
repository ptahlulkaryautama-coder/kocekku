...
export default {
  ...
  debts: {
    ...
    amount: 'Amount',
    person: 'Person',
    personPlaceholder: 'Who? (e.g., John, Budi)',
    ...
    daysUntilDue: '{days} days left',
    daysOverdue: '{days} days overdue',
    dueToday: 'Due today',
    noDebts: 'No debts yet.',
    noDebtsDesc: 'Add a debt to start tracking lending.',
    scanQR: 'Scan QR to accept',
    shareQR: 'Share QR',
    debtPaid: 'Debt marked as paid.',
    debtDeleted: 'Debt deleted.',
    confirmDelete: 'Are you sure you want to delete this debt?',
    // Installments
    installment: 'Installment',
    installments: 'Installments',
    enableInstallments: 'Pay in Installments',
    ...
    monthly: 'Monthly',
    paid: 'Paid',
    paidCount: '{paid} of {total} payments',
    remaining: 'Remaining',
    ...
    paymentNotePlaceholder: 'e.g., First installment',
    paymentRecorded: 'Payment recorded successfully.',
    nextDueDate: 'Next Due',
    paymentSchedule: 'Payment Schedule',
    fullyPaid: 'Fully Paid',
    partialPayment: 'Partial Payment',
    overpaid: 'Overpaid by {amount}',
    schedule: 'Schedule',
    history: 'History',
  },
